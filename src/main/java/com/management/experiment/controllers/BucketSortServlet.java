...
public class BucketSortServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Extract the numbers from the JSON object
            String numbersStr = jsonObject.get("numbers").getAsString();
            ...
            // Compute the bucket size dynamically based on the length of the array
            int bucketSize = numbers.length;

            // Sort the array using Bucket Sort
            int[] sortedNumbers = SortingAlgorithms.bucketSort(numbers, bucketSize);
